...
import { StyleSheet, Text, View, Image, Dimensions, Button, ScrollView} from 'react-native'
import eventData from '../../../Data/eventListData';

const windowWidth = Dimensions.get('window').width;
const windowHeight = Dimensions.get('window').height;

const FullMoonScreen = ({route}) => {
    const e_data = eventData[7];
    return (
